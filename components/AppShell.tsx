...
import { Target, LineChart, Settings, Menu, ChevronDown, ChevronRight, Crosshair, Eye, Zap, Radius, LogOut, User, LayoutGrid, Package, BarChart3, Trophy } from "lucide-react";
...
const analyticsItems = [
  ...
  { name: "Best Bulls", href: "/analytics/bulls", icon: Trophy },
...
const setupItems = [
  { name: "Targets", href: "/setup/targets", icon: LayoutGrid },
